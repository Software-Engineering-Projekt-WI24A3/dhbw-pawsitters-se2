...
VALUES ('lukas.schmidt@example.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOQxD9jQ2b6K8wF5gQd0mL5m8uM4uQx6K', 'Lukas', 'Schmidt', '01721234567', '1991-08-05', 'Maria Schmidt', 'lukas.png', 'Aktiver Tiersitter für Wochenendbetreuung.', 4.8, 12, 'HOST', FALSE, '68159', 'Mannheim');

INSERT INTO users (email, password_hash, first_name, last_name, phone, birth_date, emergency_contact, profile_picture, bio, rating, number_of_ratings, role, password_change_required, postal_code, city)
VALUES ('mia.fischer@example.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOQxD9jQ2b6K8wF5gQd0mL5m8uM4uQx6K', 'Mia', 'Fischer', '01741234567', '1992-06-17', 'Ben Fischer', 'mia.png', 'Ruhige Betreuung für Katzen und Kleintiere.', 4.6, 8, 'HOST', FALSE, '69115', 'Heidelberg');
...
INSERT INTO pet (name, species, breed, age, special_needs, owner_id)
VALUES ('Minka', 'CAT', 'Europäisch Kurzhaar', 2, 'Braucht täglich Medikamente', (SELECT id FROM users WHERE email = 'sara.wagner@example.com'));

INSERT INTO pet (name, species, breed, age, special_needs, owner_id)
VALUES ('Rocky', 'DOG', 'Mischling', 7, 'Etwas ängstlich bei Gewitter', (SELECT id FROM users WHERE email = 'anna.meier@example.com'));

INSERT INTO pet (name, species, breed, age, special_needs, owner_id)
VALUES ('Kiwi', 'BUDGIE', 'Wellensittich', 1, 'Käfig nachts abdecken', (SELECT id FROM users WHERE email = 'lukas.schmidt@example.com'));
