...
public final class PasswordPolicy {
    ...
    public static List<String> validate(String rawPassword, String email, String firstName, String lastName) {
        List<String> violations = new ArrayList<>();
        String normalizedPassword = PasswordNormalizer.normalize(rawPassword);
    ...
    private static boolean containsEmailPart(String password, String email) {
    ...
    private static boolean containsPersonalContextPart(String password, String firstName, String lastName) {
        String normalizedPassword = normalizeForComparison(password);
        return containsContextValue(normalizedPassword, firstName)
                || containsContextValue(normalizedPassword, lastName);
    }

    private static boolean containsContextValue(String normalizedPassword, String value) {
    ...
    private static boolean containsBlockedPasswordPart(String password) {
    ...
    private static boolean isBlockedPasswordOrSimpleVariant(String normalizedPassword, String blockedPassword) {
